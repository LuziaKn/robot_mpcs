...
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
   ...
   OUTPUT = jackal_n3_01_H10_noSlack_py.jackal_n3_01_H10_noSlack_solve(PARAMS) solves a multistage problem
   subject to the parameters supplied in the following dictionary:
       ...
       PARAMS['all_parameters'] - matrix of size [270x1]
   ...
   [OUTPUT, EXITFLAG] = jackal_n3_01_H10_noSlack_py.jackal_n3_01_H10_noSlack_solve(PARAMS) returns additionally
   ...
   [OUTPUT, EXITFLAG, INFO] = jackal_n3_01_H10_noSlack_py.jackal_n3_01_H10_noSlack_solve(PARAMS) returns 
...
try:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'jackal_n3_01_H10_noSlack/lib/jackal_n3_01_H10_noSlack_withModel.so'))
    csolver = getattr(_lib,'jackal_n3_01_H10_noSlack_solve')
except:
    _lib = ctypes.CDLL(os.path.join(os.path.dirname(os.path.abspath(__file__)),'jackal_n3_01_H10_noSlack/lib/libjackal_n3_01_H10_noSlack_withModel.so'))
    csolver = getattr(_lib,'jackal_n3_01_H10_noSlack_solve')

internal_mem = getattr(_lib,'jackal_n3_01_H10_noSlack_internal_mem')

class jackal_n3_01_H10_noSlack_params_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
    _fields_ = [('x0', ctypes.c_double * 100),
('xinit', ctypes.c_double * 8),
('all_parameters', ctypes.c_double * 270),
]

jackal_n3_01_H10_noSlack_params = {'x0' : np.array([]),
'xinit' : np.array([]),
...
jackal_n3_01_H10_noSlack_params_types = {'x0' : np.float64,
'xinit' : np.float64,
'all_parameters' : np.float64,
}

class jackal_n3_01_H10_noSlack_outputs_ctypes(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
jackal_n3_01_H10_noSlack_outputs = {'x01' : np.array([]),
'x02' : np.array([]),
'x03' : np.array([]),
'x04' : np.array([]),
'x05' : np.array([]),
...
class jackal_n3_01_H10_noSlack_info(ctypes.Structure):
#    @classmethod
#    def from_param(self):
#        return self
...
class jackal_n3_01_H10_noSlack_mem(ctypes.Structure):
    pass
...
csolver.argtypes = ( ctypes.POINTER(jackal_n3_01_H10_noSlack_params_ctypes), ctypes.POINTER(jackal_n3_01_H10_noSlack_outputs_ctypes), ctypes.POINTER(jackal_n3_01_H10_noSlack_info), ctypes.POINTER(jackal_n3_01_H10_noSlack_mem), ctypes.POINTER(FILE))
csolver.restype = ctypes.c_int

internal_mem.argtypes = [ctypes.c_uint]
internal_mem.restype = ctypes.POINTER(jackal_n3_01_H10_noSlack_mem)

def jackal_n3_01_H10_noSlack_solve(params_arg):
    '''
a Python wrapper for a fast solver generated by FORCESPRO v6.3.0
 ...
 See also COPYING
    ...
    # convert parameters
    params_py = jackal_n3_01_H10_noSlack_params_ctypes()
    for par in params_arg:
        ...
        try:
            ...
            if isinstance(getattr(params_py, par), ctypes.Array):
                params_arg[par] = np.require(params_arg[par], dtype=jackal_n3_01_H10_noSlack_params_types[par], requirements='F')
    ...
    outputs_py = jackal_n3_01_H10_noSlack_outputs_ctypes()
    info_py = jackal_n3_01_H10_noSlack_info()
    if sys.version_info.major == 2:
        ...
        try:
            PyFile_AsFile.restype = ctypes.POINTER(FILE)
            exitflag = _lib.jackal_n3_01_H10_noSlack_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), PyFile_AsFile(fp) , _lib.jackal_n3_01_H10_noSlack_adtool2forces )
        ...
        try:
            if sys.platform.startswith('win'):
                exitflag = _lib.jackal_n3_01_H10_noSlack_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), None , _lib.jackal_n3_01_H10_noSlack_adtool2forces)
            else:
                exitflag = _lib.jackal_n3_01_H10_noSlack_solve( ctypes.byref(params_py), ctypes.byref(outputs_py), ctypes.byref(info_py), internal_mem(0), fp , _lib.jackal_n3_01_H10_noSlack_adtool2forces)
            libc.fclose(fp)
    ...
    # convert outputs
    for out in jackal_n3_01_H10_noSlack_outputs:
        jackal_n3_01_H10_noSlack_outputs[out] = npct.as_array(getattr(outputs_py,out))

    return jackal_n3_01_H10_noSlack_outputs,int(exitflag),info_py

solve = jackal_n3_01_H10_noSlack_solve
