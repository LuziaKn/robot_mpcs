...
#define S_FUNCTION_NAME jackal_n3_01_H10_noSlack_simulinkBlockcompact
...
static void mdlInitializeSizes(SimStruct *S)
{
	...
	/* Input Port 2 */
    ssSetInputPortMatrixDimensions(S,  2, 270, 1);
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
    ...
    /* Call solver */
    solver_exitflag = jackal_n3_01_H10_noSlack_solve(&params, &output, &info, mem, fp , pt2function_jackal_n3_01_H10_noSlack);
	...
	for(i = 0; i < 10; i++)
	{
		outputs[10 + i] = (real_T) output.x02[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[20 + i] = (real_T) output.x03[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[30 + i] = (real_T) output.x04[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[40 + i] = (real_T) output.x05[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[50 + i] = (real_T) output.x06[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[60 + i] = (real_T) output.x07[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[70 + i] = (real_T) output.x08[i];
	}

	for(i = 0; i < 10; i++)
	{
		outputs[80 + i] = (real_T) output.x09[i];
	}
