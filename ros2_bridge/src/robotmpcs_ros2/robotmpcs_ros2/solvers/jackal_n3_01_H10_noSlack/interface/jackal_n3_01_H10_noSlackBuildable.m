...
% 
classdef jackal_n3_01_H10_noSlackBuildable < coder.ExternalDependency
    ...
    methods (Static)
        ...
        function updateBuildInfo(buildInfo, cfg)
            ...
            if(~strcmp(foldername, 'interface') || ~strcmp(solvername, 'jackal_n3_01_H10_noSlack'))
                solverpath = fullfile(buildablepath, 'jackal_n3_01_H10_noSlack');
            end
            solverInfo = struct();
            solverInfo.solvername = 'jackal_n3_01_H10_noSlack';
        ...
        function [output,exitflag,info] = forcesCallWithParams(params)
            [output,exitflag,info] = jackal_n3_01_H10_noSlackBuildable.forcesCall(params.x0, params.xinit, params.all_parameters);
        end

        function [output, exitflag, info] = forcesCall(x0, xinit, all_parameters)
            solvername = 'jackal_n3_01_H10_noSlack';
            ...
            [output_c, exitflag_c, info_c] = jackal_n3_01_H10_noSlackBuildable.forcesInitOutputsC(); %#ok<ASGLU>
            ...
            [output, exitflag, info] = jackal_n3_01_H10_noSlackBuildable.forcesInitOutputsMatlab();
